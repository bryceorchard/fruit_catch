...
IMAGES = {"Apple": load_image("res/apple.png", FRUIT_SIZE, FRUIT_SIZE),
          "Basket": load_image("res/basket.png", 110, BASKET_HEIGHT),
          "Cherry": load_image("res/cherry.png", FRUIT_SIZE, FRUIT_SIZE),
          "Pear": load_image("res/pear.png", FRUIT_SIZE, FRUIT_SIZE),
          "Background": load_image("res/background.jpg", SCREEN_WIDTH, SCREEN_HEIGHT)}
